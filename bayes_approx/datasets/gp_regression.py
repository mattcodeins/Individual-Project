...
def import_train_test():
    train, trainloader = import_dataset('bayes_approx/datasets/gp_reg_dataset/training_sample_points.csv', 128)
    test, testloader = import_dataset('bayes_approx/datasets/gp_reg_dataset/sample_function.csv', 1000)
...
if __name__ == '__main__':
    train, test, trainloader, testloader = import_train_test()
    print(train.shape)
    print(test.shape)
