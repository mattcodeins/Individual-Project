...
if __name__ == "__main__":
    # print(full_training(
    #     n_epochs=40000, num_layers=1, h_dim=50, activation='relu',
    #     prior_weight_std=1.0, prior_bias_std=1.0, init_std=0.1
    # ))
    # print(full_training(
    #     n_epochs=40000, num_layers=1, h_dim=50, activation='relu',
    #     prior_weight_std=1.0, prior_bias_std=3.0, init_std=0.1
    # ))
    # print(full_training(
    #     n_epochs=40000, num_layers=1, h_dim=50, activation='relu',
    #     prior_weight_std=3.0, prior_bias_std=1.0, init_std=0.1
    # ))
    bnn_cross_val()
